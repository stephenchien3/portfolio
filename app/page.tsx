      ...
      <main style={{position: 'relative', maxWidth: '1400px', margin: '0 auto', padding: '0 20px'}}>
        ...
        <div style={{position: 'absolute', left: '-250px', top: '100px', width: '200px'}}>
          <div style={{marginBottom: '40px'}}>
            ...
            <p style={{fontSize: '0.7em', marginTop: '5px', fontStyle: 'italic'}}>
              Y. Nara, <i>Knife Behind Back</i> (2000)
            </p>
          </div>
          ...
          <div style={{marginBottom: '40px'}}>
            ...
            />
            <p style={{fontSize: '0.7em', marginTop: '5px', fontStyle: 'italic'}}>
              Ai Weiwei, <i>Sunflower Seeds</i> (2010)
            </p>
          </div>
        </div>
        ...
        <div style={{position: 'absolute', right: '-250px', top: '200px', width: '200px'}}>
          <div style={{marginBottom: '40px'}}>
            ...
            />
            <p style={{fontSize: '0.7em', marginTop: '5px', fontStyle: 'italic'}}>
              S. Ramón y Cajal, <i>Pyramidal neurons</i> (1904)
            </p>
          </div>
          ...
          <div style={{marginBottom: '40px'}}>
            ...
            />
            <p style={{fontSize: '0.7em', marginTop: '5px', fontStyle: 'italic'}}>
              T. Cole, <i>The Savage State</i> (1836)
            </p>
          </div>
        </div>
        ...
        <article style={{maxWidth: '700px', margin: '0 auto'}}>
          <h1>Stephen Chien</h1>
          <p className="author">
            <a href="mailto:slc292@cornell.edu">slc292@cornell.edu</a> · <a href="https://github.com/stephenchien3">GitHub</a> · <a href="https://www.linkedin.com/in/stephenlchien/">LinkedIn</a>
          </p>

          <p style={{marginBottom: '2rem', textAlign: 'center'}}>
            Current CS Masters student at Cornell.<br />
            I try to make technology for social good.
          </p>

          <section style={{marginBottom: '2rem'}}>
            <h2>Built</h2>
            <ul>
              <li><a href="https://cajalhealth.org">Cajal Health</a> - AI appeals for denied insurance claims</li>
              <li><a href="https://assesskit.com">Assesskit</a> - granular user response collection</li>
              <li><a href="https://apps.apple.com/us/app/buddhist-app-gautama/id6753130717">Gautama</a> - iOS meditation app</li>
            </ul>
          </section>
          ...
          <section style={{marginBottom: '2rem'}}>
            <h2>Labs</h2>
            <ul>
              <li><a href="https://casasanto.com">Experience and Cognition Lab</a></li>
              <li><a href="https://gao.cee.cornell.edu">Gao Research Lab</a></li>
              <li><a href="https://www.economyandsociety.org">Center for the Study of Economy and Society</a></li>
            </ul>
          </section>
          ...
          <section id="publications" className="cv-section">
            ...
            <div className="cv-item">
              ...
              <p className="date-range">
                October 2025 · <a href="https://doi.org/10.1109/MASS66014.2025.00106">DOI</a>
              </p>
