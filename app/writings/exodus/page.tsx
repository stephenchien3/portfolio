  ...
  return (
    <main className="page-container">
      ...
      <div className="detail-content" style={{ lineHeight: '1.8' }}>
        <p>They waited. And waited. And waited.</p>
        ...
        <p>"You look interesting." The kid was analyzing the old man from top to bottom.</p>

        <p>"I've just been a while."</p>

        <p>"Where are you from?" Asked the kid.</p>
